...
public class Main {
    public static void main(String[] args) {
        ...
        User player1 = new User(12L, "A", "B", "C", 12, List.of(new Role("USER")), "USD", false);
        User player2 = new User(13L, "A", "B", "C", 12, List.of(new Role("USER")), "USD", false);
        User player3 = new User(14L, "A", "B", "C", 12, List.of(new Role("USER")), "USD", false);
        User player4 = new User(15L, "A", "B", "C", 12, List.of(new Role("USER")), "USD", false);
